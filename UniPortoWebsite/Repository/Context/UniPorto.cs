namespace UniPortoWebsite.Repository.Context
{
    using System;
    ...
    public partial class UniPorto : DbContext
    {
        ...
        public virtual DbSet<AttachmentsType> AttachmentsType { get; set; }
        ...
        public virtual DbSet<RecommendationQueue> RecommendationQueue { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Activity>()
    .HasMany(e => e.RecommendationQueue)
    .WithRequired(e => e.Activity)
    .WillCascadeOnDelete(false);
